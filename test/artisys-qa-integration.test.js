...
test('PDV release profile gates reporting v2, core business, Products deep E2E, Products/Customers cross-flow, enterprise depth, backend/UI parity and fiscal E2E',()=>{
  const config=readJson('qa/artisys-qa.config.json');
  const releaseFlows=['smoke','home','reports-v2-complete','core-business-e2e','ux-products-clients-cross-flow','products-deep-e2e','enterprise-depth-p0','backend-parity-p0','backend-parity-p1','ui-parity-p0-p2','fiscal-block6','fiscal-ui-parity-baseline','fiscal-config-p2-p5','fiscal-nfse-p8'];
