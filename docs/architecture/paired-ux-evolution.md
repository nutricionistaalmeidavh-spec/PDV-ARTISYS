...
O teste `paired-ux-evolution-guard.test.js` compara diretamente os dois contratos. O teste `ux-products-clients-release-regression.test.js` exige ainda o cross-flow e o gate completo de release.
