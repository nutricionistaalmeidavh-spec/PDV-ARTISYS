...
(() => {
  ...
  async function renderReportsV2(next = {}) {
    ...
    document.getElementById('ops-commission-rule')?.addEventListener('submit',async event => {
      event.preventDefault();
      const form = new FormData(event.currentTarget);
      try {
