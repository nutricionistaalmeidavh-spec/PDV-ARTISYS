...
- Node.js 22+;
- Windows x64 é o alvo de empacotamento comercial 1.3.5.
...
npm run dist:win
npm run release:manifest -- --output dist/release-manifest.json --artifact dist/ArtiSys-PDV-1.3.5-x64-Setup.exe
```
