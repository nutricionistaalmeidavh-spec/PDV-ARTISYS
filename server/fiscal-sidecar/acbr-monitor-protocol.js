...
function renderNfceIni(document = {}) {
  ...
  pushSection(lines, 'Identificacao', [['cUF',stateCode],['cNF',identification.numericCode],['natOp',identification.operationNature],['mod','65'],['serie',identification.series],['nNF',identification.number],['dhEmi',acbrDateTime(identification.issuedAt)],['tpNF','1'],['idDest','1'],['cMunFG',address.cityCode],['tpImp','4'],['tpEmis','1'],['tpAmb',environment==='production'?'1':'2'],['finNFe','1'],['indFinal','1'],['indPres','1'],['procEmi','0'],['verProc','ArtiSys PDV']]);
