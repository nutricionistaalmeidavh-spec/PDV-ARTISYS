...
function createLocalServer({runtime,host='127.0.0.1',port=4174,token='',bodyLimitBytes=1024*1024,allowedOrigins=[]}={}){
  const handler=createRouter({runtime,installationToken:token,bodyLimitBytes,allowedOrigins});let server=null;
